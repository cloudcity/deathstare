...
# Copied from Librato::Metrics::Persistence::Direct
# To use Typheous Hydra API
module Librato
  module Metrics
    module Persistence
      class TypheousDirect
        ...
        def persist(client, queued, options={})
          ...
          requests.each do |request|
            ...
            # expects 200
            req = LibratoApiV1.construct_request(url: '/metrics', method: 'post', body: payload)
